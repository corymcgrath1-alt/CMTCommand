...
export default async function MyAssignmentsPage({ searchParams }: { searchParams: Promise<{ result?: string }> }) {
  ...
  return <main className="shell operations-shell">
    <OperationsHeader context={state.context} eyebrow="Field technician" title="My Assignments" description="Your linked dispatch assignments only. Field capture and reporting are not part of this phase." />
